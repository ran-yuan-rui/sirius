...
class sirius_datasource : public cudf::io::datasource {
 public:
  ...
  /// IO attribution for reads issued through this datasource (query/pipeline
  /// stamped at scan preparation; device patched at split emission, strictly
  /// before any read or prefetch arming). Copied by @c duplicate().
